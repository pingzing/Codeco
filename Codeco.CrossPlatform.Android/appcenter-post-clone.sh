...
sed --in-place .bak --expression="s/<UwpReplaceMe>/$uwp_api_key" ../Codeco.CrossPlatform/App.xaml.cs \
| sed --in-place .bak --expression="s/<AndroidReplaceMe>/$android_api_key" ../Codeco.CrossPlatform/App.xaml.cs